...
CButton* CButtonManager::Create(HMENU hMenu, const char* name, const char* text, CTexture* image, CD12Font* font, CVertex2 size, CVertex2 position, BYTE audience, BYTE type)
{
	...
	button = new CButton(m_globalObjects, hMenu, name, text, image, font, size, position, audience, type);
