...
CLine::CLine(CGlobalObjects* globalObjects, CVertex* from, CVertex* to)
{
	...
	m_vertexBuffer = new CVertexBuffer(m_globalObjects, m_commandList, CVertex::VT_VERTEXLINE, 2, m_line);
	...
	m_pipelineState = new CPipelineState(m_globalObjects, CVertex::VT_VERTEXLINE);
	...
	m_pipelineState->Create(false, false, true, D3D12_PRIMITIVE_TOPOLOGY_TYPE::D3D12_PRIMITIVE_TOPOLOGY_TYPE_LINE, m_vertexShader, m_pixelShader, nullptr, nullptr, nullptr, m_rootSignature->m_signature);
}
