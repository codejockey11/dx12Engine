...
void CCommandListBundle::Add(ComPtr<ID3D12GraphicsCommandList> commandList)
{
	...
	if (m_count > CCommandListBundle::MAX_COMMAND_LIST_COUNT)
	{
		m_errorLog->WriteError("CCommandListBundle::CCommandListBundle::Command list count exceeds maximum\n");
...
void CCommandListBundle::Execute()
{
